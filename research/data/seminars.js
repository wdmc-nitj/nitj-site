...
fetch('https://teamd.onrender.com/research/events/get?visible=visible&upcoming=true&category=seminar')
.then((response) => response.json())
  ...
  fetch('https://teamd.onrender.com/research/events/get?visible=visible&upcoming=false&category=seminar')
.then((response) => response.json())
  .then((data) => {
